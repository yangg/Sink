import type { CountryRedirect, Link } from '#shared/schemas/link'
import type { DateValue } from '@internationalized/date'
import type { AnyFieldApi } from '@tanstack/vue-form'

export type { CountryRedirect, Link }
...
type LinkFormFields = Omit<Link, 'id' | 'createdAt' | 'updatedAt' | 'expiration' | 'countryRedirects'> & {
